...
| 功能                  | 状态        | 进度 | 描述                                       |
| --------------------- | ----------- | ---- | ------------------------------------------ |
| 🎨 更现代化的 UI 界面 | ✅ 已完成   | 100% | 使用现代设计原则重构整个界面，提升用户体验 |
| 🔍 搜索功能           | ✅ 已完成   | 100% | 支持通过名称、层级等关键词快速查找存档     |
| 🎨 颜色主题           | ⏳ 开发中   | 90%  | 用户可自定义应用的颜色主题                 |
| 🌐 多语言切换         | ✅ 已完成   | 100% | 支持简体中文、繁体中文、英文               |
| 💾 存档数据编辑       | ✅ 已完成   | 100% | 允许用户直接在工具内编辑存档数据           |
| ➕ 新建存档功能拓展   | ✅ 已完成   | 100% | 支持快速创建、蓝图创建、批量创建等多种模式 |
...
## 📥 安装方式（V3.0.0-Alpha-7 测试版）

### Windows

1. 下载 [v3.0.0-Alpha-7](https://github.com/Eververdants/ETBSaveManager/releases/tag/v3.0.0-Alpha-7) 的 Windows 安装包。
