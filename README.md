...
## 📥 Installation (V3.0.0-Alpha-6.1 Test Version)

1. Download the Windows installer for [v3.0.0-Alpha-6.1](https://github.com/Eververdants/ETBSaveManager/releases/tag/v3.0.0-Alpha-6.1).
