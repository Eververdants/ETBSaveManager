...
## 📥 Installation (V3.0.0-Alpha-5)

### Windows

1. Download the Windows installer for [v3.0.0-Alpha-5](https://github.com/Eververdants/ETBSaveManager/releases/tag/v3.0.0-Alpha-5).
