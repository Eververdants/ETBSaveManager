...
function ScreenMock({ id }: { id: string }): React.JSX.Element {
  const { t } = useTranslation();
  return (
    <div className="relative overflow-hidden border-[1.5px] border-[var(--color-ink)] bg-[var(--color-paper)] shadow-[6px_6px_0_0_var(--color-ink)] transition-shadow group-hover:shadow-[8px_8px_0_0_var(--color-ink)] dark:border-[var(--color-paper-3)] dark:bg-[#15110d] dark:shadow-[6px_6px_0_0_var(--color-paper-3)] dark:group-hover:shadow-[8px_8px_0_0_var(--color-paper-3)]">
