...
Ending1_levels = [
    "Level 0", "Level 1 (1)", "Level 1 (2)", "Level 1 (3)", "Level 1 (4)", "The Hub", "Level 2 (1)", "Level 3", "Level 4", "Level 5 (1)", "Level 5 (2)", "Level 5 (3)", "Level 2 (2)", "Level Fun", "Level 37", "Level !", "The End", "Level 922……", "Level 94 (1)", "Level 94 (2)", "Level 6", "Level 7", "Level 8", "Level 0.11", "Level 9 (1)", "Level 9 (2)", "Level 10", "Level 3999", "Level 0.2", "Level 6.1", "Level !-!", "Level 188", "Level 37.2 (1)", "Level 37.2 (2)","Level 37.2 (3)", "Level 37.2 (4)", "Level FUN+(1)",  "Level FUN+(2)", "Level FUN+(3)", "Level FUN+(4)", "Level FUN+(5)","Level 52", "Level 55.1"
]
Ending2_levels = []
Ending3_levels = []
Ending4_levels = []
...
def check_update():
    webbrowser.open_new("https://github.com/llzgdc/EscapeTheBackroomsSaveGamesTools/releases")
