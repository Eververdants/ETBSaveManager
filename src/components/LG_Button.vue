...
const btnStyle = computed(() => ({
  ...
  "--halo-color":
    colorMap.value[props.type]?.halo || colorMap.value.default.halo,
}));
...
.living-glass-btn {
  ...
  box-shadow: 0 2px 8px 0 rgba(70, 130, 255, 0.1),
    /* 外层投影 */ 0 1.5px 0 0 rgba(255, 255, 255, 0.18) inset,
    /* 内层高光 */ 0 0 0 1px rgba(255, 255, 255, 0.18) inset; /* 内发光 */
...
.living-glass-btn:focus-visible {
  box-shadow: 0 0 0 2px rgba(138, 158, 255, 0.5),
    0 2px 8px 0 rgba(70, 130, 255, 0.1);
}
