...
const useDropdownPosition = (dropdownRef, menuRef, isOpen, menuStyle) => {
  ...
  return { updateMenuPosition, handleScroll };
};

const useDropdownAnimations = (menuRef, isAnimating) => {
  ...
  return { handleMenuEnter, handleMenuLeave };
};

const useDropdownActions = (props, emit, isOpen, isAnimating) => {
