  ...
  if (!releaseNotesCache) {
    ...
    try {
      if (typeof __RELEASE_NOTES_ZH_CN__ !== 'undefined') {
        releaseNotesCache['zh-CN'] = Array.isArray(__RELEASE_NOTES_ZH_CN__) ? __RELEASE_NOTES_ZH_CN__ : []
      }
      if (typeof __RELEASE_NOTES_EN_US__ !== 'undefined') {
        releaseNotesCache['en-US'] = Array.isArray(__RELEASE_NOTES_EN_US__) ? __RELEASE_NOTES_EN_US__ : []
      }
      if (typeof __RELEASE_NOTES_ZH_TW__ !== 'undefined') {
        releaseNotesCache['zh-TW'] = Array.isArray(__RELEASE_NOTES_ZH_TW__) ? __RELEASE_NOTES_ZH_TW__ : []
      }
    } catch (error) {
